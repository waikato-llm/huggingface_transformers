...
def interact(model_dir, base_model="NousResearch/Llama-2-7b-chat-hf", max_length=200, raw=False, quantization="4bit"):
    """
    ...
    """
    model, tokenizer = load_finetuned_model(base_model, model_dir, quantization=quantization)
...
def main(args=None):
    ...
    interact(parsed.model_dir, base_model=parsed.base_model, max_length=parsed.max_length, quantization=parsed.quantization)
