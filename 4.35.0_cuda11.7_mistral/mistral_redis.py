...
def main(args=None):
    ...
    :type args: list
    """
    parser = create_parser('Mistral - Prediction (Redis)', prog="mistral_redis", prefix="redis_")
    parser.add_argument('--model_dir', metavar="PATH", type=str, required=True, help='The dir with the fine-tuned model.')
    parser.add_argument('--base_model', metavar="NAME_OR_PATH", type=str, default="mistralai/Mistral-7B-Instruct-v0.1", required=False, help='The name/dir base model to use')
