...
def finetune(train_data, output_dir, base_model="mistralai/Mistral-7B-v0.1", lora_alpha=16, lora_dropout=0.1, lora_r=64,
...
def main(args=None):
    ...
    parser = argparse.ArgumentParser(
        description="Mistral - Fine-tune a model",
        prog="mistral_finetune",
    ...
    parser.add_argument('--lora_dropout', metavar="FLOAT", type=float, default=0.05, required=False, help='The lora dropout')
    parser.add_argument('--lora_r', type=int, metavar="INT", default=16, required=False, help='The lora attention dimension.')
